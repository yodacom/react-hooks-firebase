...
function useTimes(sortBy = "TIMES_ASC") {
  const [times, setTimes] = useState([]);

  useEffect(() => {
    // we need an unsubscribe callback to turn off socket when done so we name this const to be available to return at the end as an unsubscribe when finished.
